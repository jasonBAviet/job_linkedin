...
export const BA_CORE_SKILLS: TaxonomySkillItem[] = [
  {
    ...
    aliases: ["BRD", "SRS", "FRD", "Requirement Gathering", "Requirement Elicitation", "Đặc tả yêu cầu"],
    category: "CORE",
  ...
  },
  {
    ...
    aliases: ["Data Mapping", "ERD", "Entity Relationship", "Database Schema", "Sơ đồ thực thể"],
    category: "CORE",
    targetRoles: ["BUSINESS_ANALYST", "DATA_ANALYST"],
  ...
  },
  {
    ...
    aliases: ["Stakeholder Management", "Quản lý các bên liên quan", "Facilitation", "Đàm phán yêu cầu"],
    category: "SOFT_SKILL",
    targetRoles: ["BUSINESS_ANALYST"],
...
export const DA_CORE_SKILLS: TaxonomySkillItem[] = [
  {
    ...
    aliases: ["SQL", "PostgreSQL", "MySQL", "T-SQL", "PL/SQL", "Window Functions", "CTEs", "Truy vấn SQL"],
    category: "CORE",
  ...
  {
    name: "Power BI & DAX",
    aliases: ["Power BI", "PowerBI", "DAX", "Power Query", "M-Code", "Báo cáo Power BI"],
    category: "TOOL",
  ...
  },
  {
    ...
    aliases: ["Data Modeling", "Star Schema", "Snowflake Schema", "Data Warehouse", "DWH", "Kho dữ liệu"],
    category: "CORE",
    targetRoles: ["DATA_ANALYST"],
...
export const COMMON_TOOLS: TaxonomySkillItem[] = [
  {
    ...
    aliases: ["Jira", "Confluence", "Atlassian", "Quản lý backlog"],
    category: "TOOL",
    targetRoles: ["BUSINESS_ANALYST", "DATA_ANALYST"],
  ...
  },
  {
    ...
    aliases: ["API", "Postman", "REST API", "JSON", "Swagger", "Tích hợp hệ thống"],
    category: "TOOL",
    targetRoles: ["BUSINESS_ANALYST"],
    description: "Hiểu cấu trúc dữ liệu giao tiếp giữa các hệ thống phần mềm",
    defaultWeight: 6,
  },
];
...
export const DOMAIN_KNOWLEDGE: TaxonomySkillItem[] = [
  {
    ...
    aliases: ["Supply Chain", "Logistics", "Kho bãi", "Vận tải", "WMS", "TMS", "Khu công nghiệp", "Sản xuất"],
    category: "DOMAIN",
    targetRoles: ["BUSINESS_ANALYST", "DATA_ANALYST"],
  ...
  },
  {
    ...
    aliases: ["E-Commerce", "Retail", "Bán lẻ", "Thương mại điện tử", "Omnichannel", "POS", "CRM"],
    category: "DOMAIN",
    targetRoles: ["BUSINESS_ANALYST", "DATA_ANALYST"],
    description: "Nghiệp vụ bán lẻ đa kênh, lòng trung thành khách hàng và vận hành đơn hàng",
    defaultWeight: 6,
  },
];
